...
export const TASK_SESSIONS_COPY = {
  en: {
    ...
    provider: "Provider", agent: "Optional Agent Context", manual: "Manual Context · optional",
    ...
    noProvider: "No available Provider on this Runtime", noAgent: "None", updated: "Updated",
  },
  "zh-CN": {
    ...
    provider: "Provider", agent: "可选 Agent 上下文", manual: "Manual Context · 可选",
    ...
    noProvider: "此 Runtime 没有可用 Provider", noAgent: "无附加上下文", updated: "更新时间",
  },
} as const;
