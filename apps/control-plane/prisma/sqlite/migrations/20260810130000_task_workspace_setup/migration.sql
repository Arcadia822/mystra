CREATE TABLE "task_workspaces" (
    ...
    "ready_at" TEXT,
    CONSTRAINT "task_workspaces_task_id_fkey" FOREIGN KEY ("task_id") REFERENCES "tasks" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "task_workspaces_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "task_workspaces_runtime_id_fkey" FOREIGN KEY ("runtime_id") REFERENCES "runtimes" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "task_workspaces_connection_id_fkey" FOREIGN KEY ("connection_id") REFERENCES "integration_connections" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "task_workspaces_issue_connection_id_fkey" FOREIGN KEY ("issue_connection_id") REFERENCES "integration_connections" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "task_workspaces_team_id_fkey" FOREIGN KEY ("team_id") REFERENCES "teams" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE "workspace_preparation_attempts" (
    ...
    "failure_code" TEXT,
    "created_at" TEXT NOT NULL,
    CONSTRAINT "workspace_preparation_attempts_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "task_workspaces" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
