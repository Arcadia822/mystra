...
CREATE TABLE "session_event_heads" (
  ...
  CONSTRAINT "session_event_heads_session_id_fkey" FOREIGN KEY ("session_id") REFERENCES "sessions" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "session_event_streams" (
  ...
  CONSTRAINT "session_event_streams_session_id_fkey" FOREIGN KEY ("session_id") REFERENCES "sessions" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "session_dispatch_leases" (
  ...
  "updated_at" TEXT NOT NULL,
  CONSTRAINT "session_dispatch_leases_session_id_fkey" FOREIGN KEY ("session_id") REFERENCES "sessions" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT "session_dispatch_leases_runtime_id_fkey" FOREIGN KEY ("runtime_id") REFERENCES "runtimes" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
