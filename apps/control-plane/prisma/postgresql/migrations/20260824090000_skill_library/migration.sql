...
CREATE INDEX "skills_team_id_status_updated_at_id_idx" ON "skills"("team_id", "status", "updated_at" DESC, "id" DESC);
CREATE INDEX "skills_team_id_name_archived_at_idx" ON "skills"("team_id", "name", "archived_at" DESC);
...
CREATE INDEX "skill_revisions_skill_id_sequence_idx" ON "skill_revisions"("skill_id", "sequence" DESC);
CREATE INDEX "skill_revisions_skill_id_publication_status_created_at_idx" ON "skill_revisions"("skill_id", "publication_status", "created_at" DESC);

ALTER TABLE "skills" ADD CONSTRAINT "skills_team_id_fkey" FOREIGN KEY ("team_id") REFERENCES "teams"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "skills" ADD CONSTRAINT "skills_created_by_user_id_fkey" FOREIGN KEY ("created_by_user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "skills" ADD CONSTRAINT "skills_archived_by_user_id_fkey" FOREIGN KEY ("archived_by_user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "skill_revisions" ADD CONSTRAINT "skill_revisions_base_revision_id_fkey" FOREIGN KEY ("base_revision_id") REFERENCES "skill_revisions"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "skill_revisions" ADD CONSTRAINT "skill_revisions_created_by_user_id_fkey" FOREIGN KEY ("created_by_user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "skills" ADD CONSTRAINT "skills_current_revision_id_fkey" FOREIGN KEY ("current_revision_id") REFERENCES "skill_revisions"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
