...
ALTER TABLE "task_execution_attempts" ADD CONSTRAINT "task_execution_attempts_team_id_fkey" FOREIGN KEY ("team_id") REFERENCES "teams"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "task_execution_attempts" ADD CONSTRAINT "task_execution_attempts_task_id_fkey" FOREIGN KEY ("task_id") REFERENCES "tasks"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "task_execution_attempts" ADD CONSTRAINT "task_execution_attempts_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "task_execution_attempts" ADD CONSTRAINT "task_execution_attempts_agent_id_fkey" FOREIGN KEY ("agent_id") REFERENCES "agents"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "task_execution_attempts" ADD CONSTRAINT "task_execution_attempts_runtime_id_fkey" FOREIGN KEY ("runtime_id") REFERENCES "runtimes"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "task_execution_attempts" ADD CONSTRAINT "task_execution_attempts_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "task_workspaces"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "task_execution_attempts" ADD CONSTRAINT "task_execution_attempts_session_id_fkey" FOREIGN KEY ("session_id") REFERENCES "sessions"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
