...
- 2026-08-17: Feature 054 renamed the internal `Harness` contract to
  `TaskExecutionAttempt` and the Task lifecycle field from `productionStatus`
  ...
  TaskExecutionAttempt remains an internal coordination record with no product
...
- 2026-08-13: Feature 054 replaced the six-state Task vocabulary introduced by
  ...
  Session/TaskExecutionAttempt failures remain independent facts. Under the pre-0.1
...
- 2026-08-11: Amended feature 051 to add the thin Task production state machine
  ...
  TaskExecutionAttempt owns no parallel lifecycle, and only Human actors may complete or
...
- 2026-08-11: Reframed Mystra's product direction as a flexible software factory. Task is the
  production order, Agent is the responsible producer, TaskExecutionAttempt identifies one
