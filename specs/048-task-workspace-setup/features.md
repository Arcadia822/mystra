...
- Session：当前仅支持 Task-bound Session，并附着已有 ready Task Workspace；Project-only 与 standalone Session 延后。
...
2. `049`：仅实现 Task-bound Session launch，消费同一 Task Workspace attachment。
