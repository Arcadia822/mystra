...
- MCP submission is the freeze point for execution-facing spec context; later collaborative edits require a new submission.
- Sandbox execution consumes injected artifacts, including the frozen execution-facing spec when applicable, rather than collaborative chat history.
