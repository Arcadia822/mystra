...
- [x] T003 [P] Add shared-schema tests in `packages/shared/src/repository.test.ts` and `packages/shared/src/result.test.ts` for GitHub review handles, `review_failed_after_push`, and transitional `mrUrl` / `mrIid` serialization
