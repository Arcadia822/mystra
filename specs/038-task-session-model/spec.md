...
**Supersession Notice (2026-08-08)**: Feature 046 and the current constitution supersede this historical ownership model. Task is Team-scoped and does not belong to Project. Session is independently Team-scoped, belongs to neither Task nor Project, and may separately reference `0..1` Task and `0..1` Project. All Project-owned Task, Task-owned Session, inherited Project/Repository, and one-to-many parenthood requirements below are historical and non-authoritative.
