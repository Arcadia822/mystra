...
This project is indexed by GitNexus as **mystra** (2794 symbols, 4690 relationships, 184 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
