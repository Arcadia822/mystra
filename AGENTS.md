...
This project is indexed by GitNexus as **mystra** (2688 symbols, 4522 relationships, 179 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
